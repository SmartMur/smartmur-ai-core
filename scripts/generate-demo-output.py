...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Generate static demo output from claw CLI")
    parser.add_argument(
        "--output-dir",
        type=Path,
    ...
    # Generate index file
    index_lines = ["# Demo Output Index", "# Generated by generate-demo-output.py", ""]
